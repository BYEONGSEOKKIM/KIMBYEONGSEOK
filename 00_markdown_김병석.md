...
![](C:\Users\KBS1\Desktop\다운로드.png) ![](C:\Users\KBS1\Desktop\다운로드 (1).png)
...
[깃허브사이트](www.github.com)

[구글사이트](www.google.com)
...
> git은 컴퓨터 파일의 변경사항을 추적하고 여러명의 사용자들 간에 해당 파일들의 작업을 조율하기 위한 분산 버전관리 시스템이다.
